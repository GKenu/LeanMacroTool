...
Public Sub NavigateToCell(fullAddress As String)
    ...
    If Left(fullAddress, 1) = "[" Then
        ...
        If wb Is Nothing Then
            MsgBox "Workbook '" & workbookName & "' not open", vbExclamation
            Exit Sub
        End If
    Else
    ...
    If pos > 0 Then
        ...
        If ws Is Nothing Then
            MsgBox "Sheet '" & sheetName & "' not found in " & wb.Name, vbExclamation
            Exit Sub
        End If
        ...
        If targetRange Is Nothing Then
            MsgBox "Invalid address: " & cellAddress, vbExclamation
            Exit Sub
        End If
